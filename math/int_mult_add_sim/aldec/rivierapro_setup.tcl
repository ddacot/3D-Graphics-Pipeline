...
# ACDS 18.1 625 win32 2020.04.15.17:28:39
# ----------------------------------------
...
# ----------------------------------------
# If int_mult_add is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "int_mult_add"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/int_mult_add.v"
}
