...
# ACDS 18.1 625 win32 2020.04.13.16:04:33
# ----------------------------------------
...
# ----------------------------------------
# If altfp_multiplier is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "altfp_multiplier"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altfp_multiplier.vo"
}
